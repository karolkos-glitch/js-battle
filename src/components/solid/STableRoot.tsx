    ...
    <div>
      <div>
        ...
        <div class="join join-horizontal">
          <button class="join-item btn btn-primary" onClick={fillData}>
            Fill the data
          </button>
          <button class="join-item btn btn-secondary" onClick={replaceSomeRows}>
            Replace some rows
          </button>
          <button class="join-item btn btn-accent" onClick={removeSomeRows}>
            Remove some rows
          </button>
          <button class="join-item btn btn-neutral" onClick={resetTableRows}>
